...
export default function ScanV2() {
  ...
  const liveComplianceSummary = {
    ...
    outOfScope: Number(baseSummary.outOfScope || baseSummary.outOfScopeRules || 0) + resolvedNotApplicableCount,
  };
