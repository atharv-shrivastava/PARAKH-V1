...
export default function BatchAlerts() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (mineResponse.ok) setReports(mineData.reports || []);
