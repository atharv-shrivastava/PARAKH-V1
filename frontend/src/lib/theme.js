export const THEMES = [
  { id: "red", name: "Red", primary: "#dc2626", background: "#fff7f7", surface: "#ffffff", text: "#2b1212", muted: "#765f5f", border: "#f0d6d6", sidebar: "#4a1010" },
  { id: "blue", name: "Blue", primary: "#2563eb", background: "#f5f7fb", surface: "#ffffff", text: "#172033", muted: "#647084", border: "#e1e6ef", sidebar: "#111827" },
  { id: "green", name: "Green", primary: "#16a34a", background: "#f4fbf6", surface: "#ffffff", text: "#10231a", muted: "#607468", border: "#d9eadf", sidebar: "#0b3a20" },
  { id: "dark-red", name: "Dark Red", primary: "#991b1b", background: "#16090a", surface: "#211012", text: "#fff1f1", muted: "#c7a0a0", border: "#472124", sidebar: "#070304" },
  { id: "dark-blue", name: "Dark Blue", primary: "#1d4ed8", background: "#080f1d", surface: "#111b2e", text: "#eff6ff", muted: "#9eb0c9", border: "#263754", sidebar: "#030812" },
  { id: "dark-green", name: "Dark Green", primary: "#166534", background: "#07120b", surface: "#0d1d13", text: "#ecfdf5", muted: "#9ebaaa", border: "#1d3b29", sidebar: "#030b06" },
];
